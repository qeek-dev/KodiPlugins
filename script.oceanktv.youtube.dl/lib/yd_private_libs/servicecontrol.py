...
BASE_COMMAND = 'XBMC.NotifyAll(script.oceanktv.youtube.dl,{0},"{{{1}}}")'
BASE_ARG = '\\"{0}\\":\\"{1}\\"'
...
class ServiceControl(object):
    ...
    @property
    def status(self):
        return xbmc.getInfoLabel('Window(10000).Property(script.oceanktv.youtube.dl_STATUS)')

    @status.setter
    def status(self, value):
        xbmcgui.Window(10000).setProperty('script.oceanktv.youtube.dl_STATUS', value)
